...
- **تنظیم سرور** (Domain) و **DNS Resolver** (در صورت نیاز، یک یا چند DNS با جداکننده فاصله/کاما/خط جدید)
...
- **اتو ری‌استارت**: در صورت خروج غیرمنتظره پردازش VPN، برنامه می‌تواند به‌صورت خودکار دوباره آن را اجرا کند.
- **SlipStream با چند Resolver**: می‌توانید چند DNS Resolver را با جداکننده فاصله، کاما یا خط جدید وارد کنید.
